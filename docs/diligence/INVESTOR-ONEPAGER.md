...
**Live:** [https://katoa.org](https://katoa.org) · **GitHub:** [https://github.com/kitsboy/katoa](https://github.com/kitsboy/katoa) · **Version:** `1.0.0` · **Status:** LIVE
...
## Solution
Wishlists/crowdfunding with Lightning + Nostr identity; creators keep all sats.

## Who it's for
Independent creators worldwide; supporters who want direct LN giving.

## Stage
Live MVP — payments wiring priority

## Traction (honest)
Live katoa.org; feature-rich UI; BTCPay integration code ready.

## Model / value flow
0% platform fees forever; optional tips/donations to project ops separately.
...
| Risk | Mitigation |
|------|------------|
| Payment rail incomplete until BTCPay live | Document phased wiring; LN address works today |
