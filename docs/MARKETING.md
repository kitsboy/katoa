...
```
Zero fees. Instant Bitcoin. 195+ countries. Creators keep 100%.
```

```
Keep 100% of Your Earnings. Built on Bitcoin Lightning Network.
```
...
```
Not another creator platform. Infrastructure for a better creator economy.
```
...
Traditional platforms charge **5–20%** plus payment processing. Most require:

- A bank account  
- KYC / government ID  
- Living in a “supported” country (~10–50)  
- Waiting **7–30 days** for payout  
- Accepting censorship and deplatforming risk  

**The creator does the work. The platform owns the relationship and skims forever.**

For givers: you want to help someone directly. Instead you get surveillance checkout, hidden fees, and slow settlement.

**Emotional hook:** *“How much of your support actually reached them?”*
...
- Independent creators (art, music, writing, code, education)  
- Mutual aid & community projects  
- Activists and causes censored on legacy rails  
- Unbanked or underbanked builders worldwide  
- Bitcoiners & Nostr users who want a native patronage home  

### Secondary

- Supporters who want private, low-fee giving  
- Projects needing a wishlist + funding page without rolling their own stack  

### Not yet primary

- Large enterprises needing heavy compliance tooling  
- Full e-commerce merchants (wishlist + shipping flags exist as a start)

---

## Value props vs. the old world
...
## Feature marketing matrix (10 pillars)
...
```
Payments without doxxing yourself to a corporation.
Identity you control. Financial sovereignty for creators.
```
...
```
Transparent wishlists for causes that can't wait on legacy rails.
0% platform fee means more sats reach the mission.
```
...
6. **FOSS donate loop** — footer QR + “fund free tools” narrative  
7. **Jobs board visibility** — “we're hiring via Bitcoin” (footer mailto flow)
...
## Regenerating the PDF deck

```bash
# From repo root — requires Google Chrome (macOS path below)
