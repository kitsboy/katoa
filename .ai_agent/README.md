...
- **role:** zero-fee Bitcoin creator economy (wishlists + tips)
...
| Surface | URL / path |
|---------|------------|
| Product metrics | `https://katoa.org/metrics.json` |
...
## Naming note
Some repos use `.agent/` (skills/workflows). KATOA uses **`.ai_agent/`** as the cross-site discovery index; skills stay in the host agent environment (`~/.grok/…`), not this repo.
