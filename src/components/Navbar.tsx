      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-black/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-3 text-white hover:text-orange-500 transition-colors">
              <img src="/sats.svg" alt="KATOA" className="w-10 h-10 rounded-full" />
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1 text-gray-300 hover:text-white transition-colors text-2xl"
                >
                  {languageFlags[language]}
                </button>
                {showLangMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-slate-700 border border-gray-700 rounded-lg shadow-xl py-2 z-50">
                    {Object.entries(languageFlags).map(([lang, flag]) => (
                      <button
                        ...
                        className="w-full px-4 py-2 text-left hover:bg-gray-800 text-white flex items-center gap-3"
                      >
