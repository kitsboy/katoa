    ...
    if (isMobile && typeof navigator.share === 'function') {
      try {
        await navigator.share({
          title,
          text: description || `${title} — ${t('share.promo')}`,
          url: fullUrl,
        });
        return;
      } catch (err) {
          ...
          <div className="absolute right-0 mt-2 w-64 bg-charcoal-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-xl py-2 z-50" role="menu">
            ...
            <div className="py-2">
              ...
              >
                ...
                <span className="text-sm">{t('share.linkedin')}</span>
              </a>
              ...
              >
                ...
                <span className="text-sm">{t('share.reddit')}</span>
              </a>
              ...
              >
                {copied ? (
                  <>
                    ...
                    <span className="text-sm text-green-500">{t('share.copied')}</span>
                  </>
                ) : (
                  <>
