    ...
    <div className="min-h-screen bg-gradient-to-b from-night-blue-shadow-700 via-night-blue-500 to-black text-white pt-16">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl text-night-blue-200 mb-8 leading-relaxed">
      ...
      {/* The Problem */}
      <section className="py-20 px-6 bg-gradient-to-b from-night-blue-shadow-700 to-night-blue-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-8 bg-red-900/20 border-red-500/30">
              ...
              <p className="text-night-blue-200 leading-relaxed mb-3">
                A $10k/month creator loses <span className="text-red-400 font-bold">$24,000 per year</span> to fees.
              </p>
              <div className="text-sm text-night-blue-300 border-t border-red-500/20 pt-3 mt-3">
            ...
            <Card className="p-8 bg-orange-900/20 border-orange-500/30">
              ...
              <div className="text-sm text-night-blue-300 border-t border-orange-500/20 pt-3 mt-3">
            ...
            <Card className="p-8 bg-yellow-900/20 border-yellow-500/30">
              ...
              <div className="text-sm text-night-blue-300 border-t border-yellow-500/20 pt-3 mt-3">
            ...
            <Card className="p-8 bg-blue-900/20 border-blue-500/30">
              ...
              <div className="text-sm text-night-blue-300 border-t border-blue-500/20 pt-3 mt-3">
            ...
            <Card className="p-8 bg-cyan-900/20 border-cyan-500/30">
              ...
              <div className="text-sm text-night-blue-300 border-t border-cyan-500/20 pt-3 mt-3">
          ...
          <div className="text-center mt-12">
            <Card className="inline-block p-8 bg-night-blue-shadow-700 border-2 border-red-500/30">
              <div className="flex items-center gap-4 mb-6">
                <TrendingUp size={40} className="text-red-400" />
                <div className="text-left">
                  <div className="text-night-blue-300 text-sm">Average creator loses</div>
                  <div className="text-4xl font-black text-red-400">$12,000-$24,000/year</div>
                </div>
              </div>
              <div className="text-night-blue-200 text-lg mb-4">
                <span className="text-white font-bold">ALL 5 platforms require:</span>
              </div>
              <div className="grid grid-cols-2 gap-4 text-left">
                <div className="flex items-center gap-2 text-night-blue-300">
              ...
              <div className="mt-6 pt-6 border-t border-night-blue-500">
                <div className="text-emerald-400 font-bold text-xl mb-2">KATOA requires: NOTHING</div>
                <div className="text-night-blue-300">Just a Bitcoin Lightning wallet. That's it.</div>
              </div>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-night-blue-200 text-lg leading-relaxed mb-4">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3 text-night-blue-300">
          ...
          <Card className="p-12 bg-gradient-to-br from-emerald-900/20 to-cyan-900/20 border-emerald-500/30 text-center">
            ...
            <p className="text-xl text-night-blue-200 max-w-2xl mx-auto">
      ...
      {/* Our Values */}
      <section className="py-20 px-6 bg-gradient-to-b from-night-blue-500 to-night-blue-shadow-700">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              What We Stand For
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card key={idx} className="p-8 bg-night-blue-500/50 border-night-blue-500 hover:border-emerald-500/50 transition-all hover-lift text-center">
                ...
                <p className="text-night-blue-300 leading-relaxed">{value.desc}</p>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-night-blue-shadow-700 to-black">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
          ...
          <div className="space-y-8">
            <Card className="p-8 bg-gradient-to-r from-red-900/20 to-night-blue-500 border-red-500/30">
            ...
            <Card className="p-8 bg-gradient-to-r from-blue-900/20 to-night-blue-500 border-blue-500/30">
              <div className="flex items-start gap-6">
                <div className="text-5xl">🚀</div>
                <div className="flex-1">
            ...
            <Card className="p-8 bg-gradient-to-r from-cyan-900/20 to-night-blue-500 border-cyan-500/30">
              <div className="flex items-start gap-6">
                <div className="text-5xl">🎯</div>
                <div className="flex-1">
            ...
            <Card className="p-8 bg-gradient-to-r from-yellow-900/20 to-night-blue-500 border-yellow-500/30">
              <div className="flex items-start gap-6">
                <div className="text-5xl">🔗</div>
                <div className="flex-1">
            ...
            <Card className="p-8 bg-gradient-to-r from-orange-900/20 to-night-blue-500 border-orange-500/30">
              <div className="flex items-start gap-6">
                <div className="text-5xl">🎁</div>
                <div className="flex-1">
          ...
          <Card className="mt-12 p-12 bg-gradient-to-br from-emerald-900/30 to-cyan-900/30 border-emerald-500/50 text-center">
            ...
            <p className="text-xl text-night-blue-200 max-w-3xl mx-auto mb-8 leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
              <div className="p-4 bg-night-blue-500/50 rounded-lg border border-emerald-500/30">
                <div className="text-emerald-400 font-bold mb-2">✓ 0% Fees Forever</div>
                <div className="text-sm text-night-blue-300">Not promotional. How it works.</div>
              </div>
              <div className="p-4 bg-night-blue-500/50 rounded-lg border border-emerald-500/30">
                <div className="text-emerald-400 font-bold mb-2">✓ Instant Payouts</div>
                <div className="text-sm text-night-blue-300">Lightning settles in seconds.</div>
              </div>
              <div className="p-4 bg-night-blue-500/50 rounded-lg border border-emerald-500/30">
                <div className="text-emerald-400 font-bold mb-2">✓ No Bank Needed</div>
                <div className="text-sm text-night-blue-300">Just a Lightning wallet.</div>
              </div>
              <div className="p-4 bg-night-blue-500/50 rounded-lg border border-emerald-500/30">
                <div className="text-emerald-400 font-bold mb-2">✓ 195+ Countries</div>
                <div className="text-sm text-night-blue-300">Works everywhere equally.</div>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 bg-gradient-to-br from-night-blue-500 to-night-blue-500 border-night-blue-500">
              ...
              <p className="text-night-blue-200 leading-relaxed mb-4">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-night-blue-shadow-700 to-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Card className="p-12 bg-night-blue-500/50 border-night-blue-500 mb-12">
            <Users size={64} className="text-emerald-400 mx-auto mb-6" />
            <p className="text-xl text-night-blue-200 leading-relaxed mb-6">
              We're a team of creators who got fed up with losing 10-20% of our earnings to platforms.
              So we built something better.
            </p>
            <p className="text-lg text-night-blue-300 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-left">
              {[
                ...
                <div key={idx} className="flex items-start gap-3 p-4 bg-night-blue-shadow-700 rounded-lg border border-night-blue-500">
                  <div className="w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Shield size={14} className="text-white" />
                  </div>
                  <span className="text-night-blue-200 text-lg">{promise}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl text-night-blue-200 mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/compare">
              <Button
                size="lg"
                variant="outline"
                className="min-w-[240px] h-16 text-xl font-bold border-2 border-night-blue-400 hover:border-emerald-500"
              >
                See the Numbers
              </Button>
            </Link>
          ...
          <p className="text-night-blue-400 text-sm mt-8">
